...
If you want to hangUp when the time out, you can call `showLeaveAlert`<swm-token data-swm-token=":src/call/index.js:163:3:3:`    const showLeaveAlert = () =&gt; {`"/> to warn the user.再试试这个。
